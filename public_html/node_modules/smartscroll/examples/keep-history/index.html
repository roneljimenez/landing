...
<body>
	<div class="section-wrapper">
		...
		<div class="section" data-hash="b">
			<div>
				<p>By default, smartscroll don't store your scrolling history into your browser history.<br>But you can enable it by passing in the <code>keepHistory: true</code> option.</p>
			</div>
		</div>
		<div class="section" data-hash="c">
			<div>
				<p>As you scroll down, check your browser history, it'll be recorded.</p>
			</div>
		</div>
	</div>
