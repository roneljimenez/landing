...
<body>
	<div class="section-wrapper">
		...
		<div class="section" data-hash="b">
			<div>
				<p>The URL hash will change as you scroll through different sections.</p>
			</div>
		</div>
		<div class="section" data-hash="c">
			<div>
				<p>You can enable this feature only, without scrolljacking - all features in smartscroll are independent of each other!</p>
			</div>
		</div>
		<div class="section" data-hash="d">
			<div>
				<p>Just include the option <code>autoHash: true,
			sectionScroll: false</code>.</p>
			</div>
		</div>
	</div>
