...
<body>
	<div class="section-wrapper">
		...
		<div class="section" data-hash="b">
			<div>
				<p>If you bookmark this page and come back to it, it will land you back at the correct position on the page</p>
			</div>
		</div>
		<div class="section" data-hash="c">
			<div>
				<p>smartscroll have this enabled by default.</p>
			</div>
		</div>
		<div class="section" data-hash="d">
			<div>
				<p>You can turn it off by passing in the option <code>initialScroll: false</code>.</p>
			</div>
		</div>
	</div>
